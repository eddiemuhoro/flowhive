<template>
  <div>
      ...
      <div class="bg-white shadow rounded-lg p-6">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            ...
            <button
              @click="openGithubImportModal"
              class="px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 flex items-center gap-2"
              title="Import commits from GitHub as tasks"
            >
              <svg
                class="w-4 h-4"
                fill="currentColor"
    ...
    <!-- GitHub Import Modal -->
    <GithubImportModal
      :show="showGithubImport"
      :project-id="projectId"
      @close="showGithubImport = false"
      @imported="handleGithubImported"
    />
...
import GithubImportModal from "@/components/project/GithubImportModal.vue";
...
const openGithubImportModal = () => {
  showGithubImport.value = true;
};

const handleGithubImported = async (count: number) => {
  alert(`Successfully imported ${count} task(s) from GitHub commits!`);
