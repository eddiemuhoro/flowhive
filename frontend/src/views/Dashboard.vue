  ...
  <div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-semibold text-gray-900">{{ taskStore.myTasks.length }}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-semibold text-gray-900">{{ completedTasks }}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-semibold text-gray-900">{{ inProgressTasks }}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-semibold text-gray-900">{{ overdueTasks }}</dd>
              </dl>
            </div>
          </div>
        </div>
    ...
    <div class="bg-white shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        ...
        <div v-else-if="taskStore.myTasks.length === 0" class="text-center py-8 text-gray-500">
        ...
        <ul v-else class="divide-y divide-gray-200">
          <li v-for="task in recentTasks" :key="task.id" class="py-4">
            <div class="flex items-center justify-between">
              <div class="flex-1">
                <RouterLink :to="`/task/${task.id}`" class="text-sm font-medium text-primary-600 hover:text-primary-800">
                  {{ task.title }}
                </RouterLink>
